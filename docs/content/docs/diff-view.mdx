---
title: Diff View
description: Review and manage changes
---
...
<img
  ...
  alt="Diff view interface in Scrawl"
  style={{
    width: '100%',
    maxWidth: '700px',
    margin: '20px auto',
...
**Commit and push**: Type a commit message and press Enter. Scrawl commits staged changes and pushes to the branch.
