---
title: File Editor
description: Edit files directly in Scrawl
---

The file editor lets you browse and edit files in a task's worktree without switching to an external editor. Use it to explore your project, make edits yourself, or review what an agent has done.

<img
  src="/media/fileeditor.png"
  alt="File editor interface in Scrawl"
  style={{
    width: '100%',
    maxWidth: '700px',
    margin: '20px auto',
