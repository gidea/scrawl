...
- [Apple Silicon (arm64)](https://github.com/gidea/scrawl/releases/latest/download/emdash-arm64.dmg)
...
- [Installer (x64)](https://github.com/gidea/scrawl/releases/latest/download/emdash-x64-installer.exe)
