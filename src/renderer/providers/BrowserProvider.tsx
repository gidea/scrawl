...
const BrowserViewRefBinder: React.FC<{
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('scrawl:browser:internal', handler as any);
    return () => window.removeEventListener('scrawl:browser:internal', handler as any);
  }, [refObj, onUrlChange]);
  return null;
};
