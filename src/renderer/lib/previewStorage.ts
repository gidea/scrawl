export const LAST_URL_KEY = (id: string) => `scrawl:browser:lastUrl:${id}`;
export const RUNNING_KEY = (id: string) => `scrawl:preview:running:${id}`;
export const INSTALLED_KEY = (id: string) => `scrawl:preview:installed:${id}`;
