...
describe('RemoteGitService', () => {
  ...
  describe('createWorktree', () => {
    ...
    it('should create worktree with default base ref', async () => {
      ...
      expect(result.path).toContain('.scrawl/worktrees');
    });
  ...
  describe('removeWorktree', () => {
    it('should remove worktree successfully', async () => {
      ...
      await service.removeWorktree(
        'conn-1',
        '/home/user/project',
        '/home/user/project/.scrawl/worktrees/test-123'
      );

      expect(mockExecuteCommand).toHaveBeenCalledWith(
        'conn-1',
        "git worktree remove '/home/user/project/.scrawl/worktrees/test-123' --force",
        '/home/user/project'
      );
    });
    ...
    it('should handle paths with spaces', async () => {
      ...
      await service.removeWorktree(
        ...
        '/home/user/my project/.scrawl/worktrees/test'
      );

      expect(mockExecuteCommand).toHaveBeenCalledWith(
        'conn-1',
        "git worktree remove '/home/user/my project/.scrawl/worktrees/test' --force",
        '/home/user/my project'
      );
    });
  });
