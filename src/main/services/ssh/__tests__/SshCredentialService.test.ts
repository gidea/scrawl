...
describe('SshCredentialService', () => {
  ...
  describe('password operations', () => {
    ...
    it('should retrieve password from keychain', async () => {
      ...
      expect(mockGetPassword).toHaveBeenCalledWith('scrawl-ssh', 'conn-1:password');
    ...
    it('should delete password from keychain', async () => {
      ...
      expect(mockDeletePassword).toHaveBeenCalledWith('scrawl-ssh', 'conn-1:password');
    });
  ...
  describe('passphrase operations', () => {
    ...
    it('should retrieve passphrase from keychain', async () => {
      ...
      expect(mockGetPassword).toHaveBeenCalledWith('scrawl-ssh', 'conn-1:passphrase');
    ...
    it('should delete passphrase from keychain', async () => {
      ...
      expect(mockDeletePassword).toHaveBeenCalledWith('scrawl-ssh', 'conn-1:passphrase');
    });
  ...
  describe('service namespacing', () => {
    it('should use correct service name for all operations', async () => {
      ...
      expect(calls.every((call) => call[0] === 'scrawl-ssh')).toBe(true);
    });
